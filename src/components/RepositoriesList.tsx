...
const RepositoriesList: React.FC = () => {
  ...
  return (
              <div>
                ...
                <Form.Control as="select" size="lg" name="documentSelected"  className="form-select form-select-lg mb-3" aria-label=".form-select-lg example">
                  <option value="2">DNI</option>
                  <option value="4">C.E.</option>
                </Form.Control>
                </div>
                <div className="input-field num">
                  <FormControl placeholder="fecha de nacimiento" aria-describedby="basic-addon1" type="text" name="fecha" className="" id="fecha"/>
                  </div>
                </InputGroup>
                <div className="input-field">
                  <FormControl placeholder="Nro. de documento" aria-describedby="basic-addon1" type="text" name="DNI" className="" id="numDocumento2"  value={term} onChange={(e) => setTerm(e.target.value)}/>
                  </div>
                <div className="input-field">
                  <FormControl placeholder="Celular"  className=" " type="text" name="phone" id="phone"  value=""/>
                </div>
                  ...
                  <div className="two-tbn text-center"><button className="btn__primary large">COMENCEMOS</button></div>
                  </form>
                  {error && <h3>{error}</h3>}
